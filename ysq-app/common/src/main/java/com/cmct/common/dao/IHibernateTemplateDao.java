...
/**
 * 文件名称:  IHibernateTemplateDao.java
 * 文件序号:  序号
 * 内容描述:  事务交由 Spring 接管的 Hibernate类
 * 版权声明:  山东鸿蝶信息技术有限公司
 * 创建用户:  zhangkai
...
/**
 * 名  称: IHibernateTemplateDao
 * 类  型: interface
 * 描  述: Spring 接管事务的 Hibernate 封装
 * 路  径: com.hongdee.common.dao
 * 作  者: zhangkai
 * 日  期: 2016/12/23 22:31
 */
public interface IHibernateTemplateDao<T> {
    /**
     * 方法名称: getSession
     * 方法描述: 获取Hibernate 会话
